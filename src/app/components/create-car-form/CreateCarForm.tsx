...
const CreateCarForm = () => {
    ...
    return (
        <form action={formAction} method="POST"
            ...
            {state.errors?.brand && <p className='text-red-500' aria-live="polite">{state.message}</p>}
            ...
            {state.errors?.price && <p className='text-red-500' aria-live="polite">{state.message}</p>}
            ...
            {state.errors?.year && <p className='text-red-500' aria-live="polite">{state.message}</p>}
